...
# ZXing / MaxiCode related jars and settings (centralized)
ZXING_STANDALONE_JAR_PATH = _get_env("ZXING_STANDALONE_JAR_PATH", "javase-3.5.3-jar-with-dependencies.jar")
ZXING_CORE_JAR_PATH = str(BASE_DIR / "maxicode" / "jar-files" / "core-3.5.0.jar")
ZXING_JAVASE_JAR_PATH = str(BASE_DIR / "maxicode" / "jar-files" / "javase-3.5.0.jar")
JCOMMANDER_JAR_PATH = str(BASE_DIR / "maxicode" / "jar-files" / "jcommander-1.82.jar")
